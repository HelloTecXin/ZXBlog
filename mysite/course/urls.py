...
from .views import CreateCourseView,DeleteCourseView,CreateLessonView
from .views import ListLessonsView,DetailLessonView,StudentListLessonView,LessonDetailView
...
urlpatterns =[
    ...
    path('lesson-detail/<int:lesson_id>',LessonDetailView.as_view(),name="lesson_detail"),
